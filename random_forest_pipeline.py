...
def main():
    ...
    parser.add_argument("--trainingdata", type=str, required=True, help="Path to the dataset (CSV file).")
    ...
    if not os.path.exists(args.trainingdata):
        raise FileNotFoundError(f"The dataset file {args.trainingdata} does not exist.")
